...
class Dialog(qt_widgets.QDialog):
    ...
    def __init__(self, parent=None):
        ...
        for n, fxn in enumerate(fxns):
            ...
            layout.addWidget(self.label[fxn], n, 1,1,1)
            # Bryson Experiment
            # layout.addWidget(self.button[fxn], n, 2)
            self.ext_label[fxn] = qt_widgets.QLabel()
            self.ext_label[fxn].setFrameStyle(frameStyle)
            layout.addWidget(self.ext_label[fxn], n, 2,1,1)
